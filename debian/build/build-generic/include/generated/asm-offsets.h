...
#define TSK_ACTIVE_MM 692 /* offsetof(struct task_struct, active_mm)	@ */
#define TSK_STACK_CANARY 772 /* offsetof(struct task_struct, stack_canary)	@ */
...
#define TI_VFPSTATE 256 /* offsetof(struct thread_info, vfpstate)	@ */
#define VFP_CPU 272 /* offsetof(union vfp_state, hard.cpu)	@ */
#define TI_THUMBEE_STATE 536 /* offsetof(struct thread_info, thumbee_state)	@ */
#define TI_IWMMXT_STATE 104 /* offsetof(struct thread_info, fpstate.iwmmxt)	@ */
...
#define SIZEOF_MACHINE_DESC 108 /* sizeof(struct machine_desc)	@ */
